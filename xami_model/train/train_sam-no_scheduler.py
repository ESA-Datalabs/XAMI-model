...
import sys
sys.path.append('/workspace/raid/OM_DeepLearning/XAMI-model/mobile_sam')
from mobile_sam import sam_model_registry, SamPredictor#, build_efficientvit_l2_encoder

# Segment Anything Model
mobile_sam_checkpoint = "/workspace/raid/OM_DeepLearning/XAMI-model/mobile_sam/weights/mobile_sam.pt"
